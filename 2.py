...
def main():
humidity = float(input("Enter the value of humidity: ")) pressure = float(input("Enter the value of pressure: ")) wind_speed = float(input("Enter the value of wind_speed: ")) time_values = list(range(0, 11))
